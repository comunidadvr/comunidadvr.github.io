...
#### ¿Debería adquirir Quest de 64 GB o 256 GB?
...
- Ve al sitio [Secure oculus](http://secure.oculus.com/)  e inicia seion para ingresar a tu cuenta
- Selecciona Perfil
...
Puedes encontrar títulos como Echo VR, Pokerstars, Elixir con hand tracking, rec room que son gratis en la tienda, llegan a ser una muy buena experiencia, de la misma manera podemos encontrar muchos juegos gratis en sidequest que te brindan una gran experiencia. Aquí una [lista de juegos gratis](https://web.facebook.com/groups/oculusquestlatam/permalink/465101314791636/) que puedes descargar para comenzar

#### ¿Puedo jugar los juegos de Quest 1 en Quest 2?

Si, todos los juegos de Quest 1 son compatibles con Quest 2 y los juegos están vinculados a tu cuenta, no a tu dispositivo.

Algunos juegos recibirán actualizaciones para mejorar los gráficos y aprovechar la potencia de procesamiento mejorada de Quest 2, solo ten en cuenta que algunos de los progresos de los juegos si son almacenados en el dispositivo.

#### ¿Puedo jugar juegos multijugador con dos quest que tienen la misma cuenta?

Existen algunos juegos que permiten esto, para la información por cada juego que permite esto puedes visitar el siguiente [link](https://docs.google.com/spreadsheets/d/1yTD4J2D4DUY1qhkAeTbF5wb_Ct-bhWKPOry3QBbgqtQ/edit)
...
Puedes consultar el link de [requerimientos de oculus](https://support.oculus.com/248749509016567/)
...
Es una tienda secundaria de Oculus en la cual podras encontrar aplicaciones que prueba o que no han sido aprovadas en la tienda principal, alguna gratis y algunas de paga, la lista de las aplicaciones de app lab en [Sidequest](https://sidequestvr.com/apps/applab/0/rating), [AppLab](https://applabdb.com) o [VRDB](https://vrdb.app/quest/lab)

#### ¿Puedo instalar canciones customizadas a Beat Saber?

Si, esto es posible gracias a BMBF te dejamos un [tutorial de instalacion de canciones](https://youtu.be/ZRIm8z2fZMI)
...
Puedes instalar un mod para poder jugar multijugador con BMBF, sin embargo solo te puede unir a salas con un codigo y/o crear tus propias salas y no te puedes unir a una partida rapida, para instalar este mod es necesario unirse al discord de [Beat Together](https://discord.com/invite/gezGrFG4tz) para poder descargar los archivos e instalarlos
...
Puedes pasar las peliculas a tu quest, sin embargo si tienes los archivos en una computadora existe un metodo para hacer streaming de estas peliculas a tu quest con un [servidor PLEX](https://youtu.be/9efsLo30ufo)
